...
int main(int argc, char** argv)
{
	...
	ei_frame_configure		(frame, &(ei_size_t){300,200},
			 			...
			 			&(int){6},
					 	&(ei_relief_t){ei_relief_raised}, &(ei_string_t) {"RATIO"}, NULL, &(ei_color_t){0xff, 0x00, 0x00, 0xff} , NULL, NULL, NULL, NULL);
	...
	ei_frame_configure		(second_frame, &(ei_size_t){100,100},
					   ...
					   &(int){6},
					   &(ei_relief_t){ei_relief_raised}, &(ei_string_t) {"RATIO"}, NULL,&(ei_color_t){0x00, 0x00, 0xff, 0xff} , NULL, NULL, NULL, NULL);
